...
export default function About() {
  return (
    <div className="max-w-[1920px] m-auto flex justify-around mt-20 ">
        <section className="w-[45%] flex flex-col items-center justify-center text-center p-6 pr-11">
        <h2 className="text-4xl font-bold  mb-8 font-sans">About Us</h2>
       ...
       <div className="w-[45%] aspect-[2/1] relative">
